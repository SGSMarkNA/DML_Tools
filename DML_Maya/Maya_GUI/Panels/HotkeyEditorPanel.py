...
########################################################################
class HotkeyEditorPanel(UI_Object.UI):
	"""
	...
	def __init__(self, name=None, **kwargs):
		...
		if name == None:
			name = cmds.hotkeyEditorPanel(**kwargs)
			super(HotkeyEditorPanel, self).__init__(name, **dict(qtParent=parent))
			
		else:
			if cmds.hotkeyEditorPanel(name, exists=True):
				super(HotkeyEditorPanel, self).__init__(name)
			else:
				name = cmds.hotkeyEditorPanel(name, **kwargs)
				super(HotkeyEditorPanel, self).__init__(name, **dict(qtParent=parent))
	#----------------------------------------------------------------------
