...
class DockControl(UI_Object.UI):
	...
	#----------------------------------------------------------------------
	def get_fixedHeight(self):
		"""
		
				Whether or not the dockControl height may be interactively resized.
				
		"""
		return self.query(fixedHeight=True)
	#----------------------------------------------------------------------
	def set_fixedHeight(self, value):
		"""
		
				Whether or not the dockControl height may be interactively resized.
				
		"""
		self.edit(fixedHeight=value)
	#----------------------------------------------------------------------
	fixedHeight = property(get_fixedHeight, set_fixedHeight)
	#----------------------------------------------------------------------
	def get_fixedWidth(self):
		"""
		
				Whether or not the dockControl width may be interactively resized.
				
		"""
		return self.query(fixedWidth=True)
	#----------------------------------------------------------------------
	def set_fixedWidth(self, value):
		"""
		
				Whether or not the dockControl width may be interactively resized.
				
		"""
		self.edit(fixedWidth=value)
	#----------------------------------------------------------------------
	fixedWidth = property(get_fixedWidth, set_fixedWidth)
	#----------------------------------------------------------------------
	...
	def get_moveable(self):
		...
		"""
		return self.query(moveable=True)
	#----------------------------------------------------------------------
	...
	def get_retain(self):
		...
		"""
		return self.query(retain=True)
	#----------------------------------------------------------------------
	def set_retain(self, value):
		"""
		...
		"""
		self.edit(retain=value)
	#----------------------------------------------------------------------
	retain = property(get_retain, set_retain)
	#----------------------------------------------------------------------
