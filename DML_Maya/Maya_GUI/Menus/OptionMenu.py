...
class OptionMenu(UI_Object.UI):
	...
	#----------------------------------------------------------------------
	@property
	def alwaysCallChangeCommand(self):
		"""
		
				Toggle whether to always call the change command, regardless of the change.
				
		"""
		return self.query(alwaysCallChangeCommand=True)
	#----------------------------------------------------------------------
	...
	def get_maxVisibleItems(self):
		...
		"""
		return self.query(maxVisibleItems=True)
	#----------------------------------------------------------------------
	def set_maxVisibleItems(self, value):
		"""
		...
		"""
		self.edit(maxVisibleItems=value)
	#----------------------------------------------------------------------
	maxVisibleItems = property(get_maxVisibleItems, set_maxVisibleItems)
	#----------------------------------------------------------------------
