...
########################################################################
class FalloffCurve(UI_Object.UI):
	"""
	...
	def __init__(self, name=None, **kwargs):
		...
		if name == None:
			name = cmds.falloffCurve(**kwargs)
			super(FalloffCurve, self).__init__(name, **dict(qtParent=parent))
			
		else:
			if cmds.falloffCurve(name, exists=True):
				super(FalloffCurve, self).__init__(name)
			else:
				name = cmds.falloffCurve(name, **kwargs)
				super(FalloffCurve, self).__init__(name, **dict(qtParent=parent))
	#----------------------------------------------------------------------
