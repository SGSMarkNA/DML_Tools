...
class ShelfButton(UI_Object.UI):
	...
	This command creates an  that is designed to be on
	...
	#----------------------------------------------------------------------
	def get_flexibleWidthType(self):
		"""
		...
		"""
		return self.query(flexibleWidthType=True)
	#----------------------------------------------------------------------
	def set_flexibleWidthType(self, value):
		"""
		...
		"""
		self.edit(flexibleWidthType=value)
	#----------------------------------------------------------------------
	flexibleWidthType = property(get_flexibleWidthType, set_flexibleWidthType)
	#----------------------------------------------------------------------
	def get_flexibleWidthValue(self):
		"""
		...
		"""
		return self.query(flexibleWidthValue=True)
	#----------------------------------------------------------------------
	def set_flexibleWidthValue(self, value):
		"""
		...
		"""
		self.edit(flexibleWidthValue=value)
	#----------------------------------------------------------------------
	flexibleWidthValue = property(get_flexibleWidthValue, set_flexibleWidthValue)
	#----------------------------------------------------------------------
	def get_flipX(self):
		"""
	...
	def menuItem(self,value):
		...
		"""
		self.edit(menuItem=value)
	#----------------------------------------------------------------------
	def menuItemPython(self,value):
		"""
		...
		"""
		self.edit(menuItemPython=value)
	#----------------------------------------------------------------------
