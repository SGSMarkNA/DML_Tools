...
########################################################################
class FalloffCurveAttr(UI_Object.UI):
	"""
	...
	def __init__(self, name=None, **kwargs):
		...
		if name == None:
			name = cmds.falloffCurveAttr(**kwargs)
			super(FalloffCurveAttr, self).__init__(name, **dict(qtParent=parent))
			
		else:
			if cmds.falloffCurveAttr(name, exists=True):
				super(FalloffCurveAttr, self).__init__(name)
			else:
				name = cmds.falloffCurveAttr(name, **kwargs)
				super(FalloffCurveAttr, self).__init__(name, **dict(qtParent=parent))
	#----------------------------------------------------------------------
	def addControlVertex(self,value):
		"""
		
				Used to add a control vertex for the curve.
				
		"""
		self.edit(addControlVertex=value)
	#----------------------------------------------------------------------
	...
	#----------------------------------------------------------------------
	def get_currentKeyValue(self):
		"""
		
				Get or set the value of the currently selected key.
				
		"""
		return self.query(currentKeyValue=True)
	#----------------------------------------------------------------------
	def set_currentKeyValue(self, value):
		"""
		
				Get or set the value of the currently selected key.
				
		"""
		self.edit(currentKeyValue=value)
	#----------------------------------------------------------------------
	currentKeyValue = property(get_currentKeyValue, set_currentKeyValue)
	#----------------------------------------------------------------------
	def get_customCurveWidget(self):
		"""
		...
		"""
		return self.query(customCurveWidget=True)
	#----------------------------------------------------------------------
	def set_customCurveWidget(self, value):
		"""
		
				Determines whether or not the curve widget is using a custom curve. When a custom curve is used, it is stored by a falloff curve in the brush tool settings, and the flag should be non-zero.
				
		"""
		self.edit(customCurveWidget=value)
	#----------------------------------------------------------------------
	customCurveWidget = property(get_customCurveWidget, set_customCurveWidget)
	#----------------------------------------------------------------------
	def deleteControlVertex(self,value):
		"""
		
				Used to delete a control vertex of the curve.
				
		"""
		self.edit(deleteControlVertex=value)
	#----------------------------------------------------------------------
	def get_docTag(self):
		"""
	...
	def get_readOnly(self):
		...
		"""
		return self.query(readOnly=True)
	#----------------------------------------------------------------------
	...
	#----------------------------------------------------------------------
	def selectedValueControl(self,value):
		"""
		
				Specifies the name of a float slider to edit the selected key value.
				
		"""
		self.edit(selectedValueControl=value)
	#----------------------------------------------------------------------
	def get_snapToGrid(self):
		"""
		
				Specifies whether or not curve control points snap to grid when they are being moved.
				
		"""
		return self.query(snapToGrid=True)
	#----------------------------------------------------------------------
	def set_snapToGrid(self, value):
		"""
		
				Specifies whether or not curve control points snap to grid when they are being moved.
				
		"""
		self.edit(snapToGrid=value)
	#----------------------------------------------------------------------
	snapToGrid = property(get_snapToGrid, set_snapToGrid)
	#----------------------------------------------------------------------
