...
class RangeControl(UI_Object.UI):
	"""
	This command creates a control used for displaying and modifying
	the current playback range.
	: only one master rangeControl may exist. Any addition rangeControls
	that a user creates are slaved to the master range control widget.
	"""
	#----------------------------------------------------------------------
