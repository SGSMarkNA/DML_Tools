...
########################################################################
class TimeFieldGrp(UI_Object.UI):
	"""
	...
	def __init__(self, name=None, **kwargs):
		...
		if name == None:
			name = cmds.timeFieldGrp(**kwargs)
			super(TimeFieldGrp, self).__init__(name, **dict(qtParent=parent))
			
		else:
			if cmds.timeFieldGrp(name, exists=True):
				super(TimeFieldGrp, self).__init__(name)
			else:
				name = cmds.timeFieldGrp(name, **kwargs)
				super(TimeFieldGrp, self).__init__(name, **dict(qtParent=parent))
	#----------------------------------------------------------------------
