...
class NodeTreeLister(UI_Object.UI):
	...
	#----------------------------------------------------------------------
	def get_nodeLibrary(self):
		"""
		
				The node library that this tree lister is currently displaying.
				
		"""
		return self.query(nodeLibrary=True)
	#----------------------------------------------------------------------
	def set_nodeLibrary(self, value):
		"""
		
				The node library that this tree lister is currently displaying.
				
		"""
		self.edit(nodeLibrary=value)
	#----------------------------------------------------------------------
	nodeLibrary = property(get_nodeLibrary, set_nodeLibrary)
	#----------------------------------------------------------------------
	@property
