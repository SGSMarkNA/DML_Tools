...
class IconTextScrollList(UI_Object.UI):
	...
	#----------------------------------------------------------------------
	def dragFeedbackVisible(self,value):
		"""
		
				Should the drag feedback be shown in the scrollbar?
				
		"""
		self.edit(dragFeedbackVisible=value)
	#----------------------------------------------------------------------
	...
	#----------------------------------------------------------------------
	def editIndexed(self,value):
		"""
		
				Index of the edited field
				
		"""
		self.edit(editIndexed=value)
	#----------------------------------------------------------------------
	...
	#----------------------------------------------------------------------
	@property
	def numberOfIcons(self):
		"""
		
				Number of icons.
				
		"""
		return self.query(numberOfIcons=True)
	#----------------------------------------------------------------------
	@property
