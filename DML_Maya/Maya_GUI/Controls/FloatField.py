...
class FloatField(UI_Object.UI):
	...
	specified with the  flag, while dragging to the left
	...
	#----------------------------------------------------------------------
	def get_showTrailingZeros(self):
		"""
		
				Show trailing zeros or not
				
		"""
		return self.query(showTrailingZeros=True)
	#----------------------------------------------------------------------
	def set_showTrailingZeros(self, value):
		"""
		
				Show trailing zeros or not
				
		"""
		self.edit(showTrailingZeros=value)
	#----------------------------------------------------------------------
	showTrailingZeros = property(get_showTrailingZeros, set_showTrailingZeros)
	#----------------------------------------------------------------------
