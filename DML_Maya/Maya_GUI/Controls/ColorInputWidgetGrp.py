...
########################################################################
class ColorInputWidgetGrp(UI_Object.UI):
	"""
	...
	def __init__(self, name=None, **kwargs):
		...
		if name == None:
			name = cmds.colorInputWidgetGrp(**kwargs)
			super(ColorInputWidgetGrp, self).__init__(name, **dict(qtParent=parent))
			
		else:
			if cmds.colorInputWidgetGrp(name, exists=True):
				super(ColorInputWidgetGrp, self).__init__(name)
			else:
				name = cmds.colorInputWidgetGrp(name, **kwargs)
				super(ColorInputWidgetGrp, self).__init__(name, **dict(qtParent=parent))
	#----------------------------------------------------------------------
