...
class Standard_QTreeView(QT.QTreeView):
	''''''
	#----------------------------------------------------------------------
	def __init__(self,*args,**kwargs):
		''''''
		super(Standard_QTreeView,self).__init__(*args,**kwargs)
	#----------------------------------------------------------------------
	def dropEvent(self, event):
		...
		return super(Standard_QTreeView,self).dropEvent(event)
	#----------------------------------------------------------------------
	def dragEnterEvent(self, event):
		...
		return super(Standard_QTreeView,self).dragEnterEvent(event)
	#----------------------------------------------------------------------
	def allColumnsShowFocus(self):
		...
		"""
		res = super(Standard_QTreeView,self).allColumnsShowFocus()
	...
	def autoExpandDelay(self):
		...
		"""
		res = super(Standard_QTreeView,self).autoExpandDelay()
	...
	def expandsOnDoubleClick(self):
		...
		"""
		res = super(Standard_QTreeView,self).expandsOnDoubleClick()
	...
	def header(self):
		...
		"""
		res = super(Standard_QTreeView,self).header()
	...
	def indentation(self):
		...
		"""
		res = super(Standard_QTreeView,self).indentation()
	...
	def isAnimated(self):
		...
		"""
		res = super(Standard_QTreeView,self).isAnimated()
	...
	def isHeaderHidden(self):
		...
		"""
		res = super(Standard_QTreeView,self).isHeaderHidden()
	...
	def isSortingEnabled(self):
		...
		The default value is false.
		"""
		res = super(Standard_QTreeView,self).isSortingEnabled()
	...
	def itemsExpandable(self):
		...
		"""
		res = super(Standard_QTreeView,self).itemsExpandable()
	...
	def rootIsDecorated(self):
		...
		By default, this property is true.
		"""
		res = super(Standard_QTreeView,self).rootIsDecorated()
	...
	def uniformRowHeights(self):
		...
		By default, this property is false.
		"""
		res = super(Standard_QTreeView,self).uniformRowHeights()
	...
	def wordWrap(self):
		...
		"""
		res = super(Standard_QTreeView,self).wordWrap()
	...
	def columnAt(self,x):
		...
		"""
		res = super(Standard_QTreeView,self).columnAt(x)
	...
	def columnViewportPosition(self,column):
		...
		"""
		res = super(Standard_QTreeView,self).columnViewportPosition(column)
	...
	def columnWidth(self,column):
		...
		"""
		res = super(Standard_QTreeView,self).columnWidth(column)
	...
	def drawBranches(self,painter,rect,index):
		...
		"""
		res = super(Standard_QTreeView,self).drawBranches(painter,rect,index)
		return res
	#----------------------------------------------------------------------
	def drawRow(self,painter,options,index):
		...
		"""
		res = super(Standard_QTreeView,self).drawRow(painter,options,index)
		return res
	#----------------------------------------------------------------------
	def drawTree(self,painter,region):
		...
		"""
		res = super(Standard_QTreeView,self).drawTree(painter,region)
		return res
	#----------------------------------------------------------------------
	def indexAbove(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).indexAbove(index)
	...
	def indexBelow(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).indexBelow(index)
		isinstance(res,QT.QModelIndex)
		return res
	#----------------------------------------------------------------------
	def indexRowSizeHint(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).indexRowSizeHint(index)
	...
	def isColumnHidden(self,column):
		...
		"""
		res = super(Standard_QTreeView,self).isColumnHidden(column)
	...
	def isExpanded(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).isExpanded(index)
	...
	def isFirstColumnSpanned(self,row,parent):
		...
		"""
		res = super(Standard_QTreeView,self).isFirstColumnSpanned(row,parent)
	...
	def isRowHidden(self,row,parent):
		...
		"""
		res = super(Standard_QTreeView,self).isRowHidden(row,parent)
	...
	def rowHeight(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).rowHeight(index)
	...
	def setAllColumnsShowFocus(self,enable):
		...
		The default is false.
		"""
		res = super(Standard_QTreeView,self).setAllColumnsShowFocus(enable)
		return res
	#----------------------------------------------------------------------
	def setAnimated(self,enable):
		...
		By default, this property is false.
		"""
		res = super(Standard_QTreeView,self).setAnimated(enable)
		return res
	#----------------------------------------------------------------------
	def setAutoExpandDelay(self,delay):
		...
		By default, this property has a value of -1, meaning that auto-expansion is disabled.
		"""
		res = super(Standard_QTreeView,self).setAutoExpandDelay(delay)
		return res
	#----------------------------------------------------------------------
	def setColumnHidden(self,column,hide):
		...
		"""
		res = super(Standard_QTreeView,self).setColumnHidden(column,hide)
		return res
	#----------------------------------------------------------------------
	def setColumnWidth(self,column,width):
		...
		"""
		res = super(Standard_QTreeView,self).setColumnWidth(column,width)
		return res
	#----------------------------------------------------------------------
	def setExpanded(self,index,expand):
		...
		"""
		res = super(Standard_QTreeView,self).setExpanded(index,expand)
		return res
	#----------------------------------------------------------------------
	def setExpandsOnDoubleClick(self,enable):
		...
		The default value is true.
		"""
		res = super(Standard_QTreeView,self).setExpandsOnDoubleClick(enable)
		return res
	#----------------------------------------------------------------------
	def setFirstColumnSpanned(self,row,parent,span):
		...
		"""
		res = super(Standard_QTreeView,self).setFirstColumnSpanned(row,parent,span)
		return res
	#----------------------------------------------------------------------
	def setHeader(self,header):
		...
		"""
		res = super(Standard_QTreeView,self).setHeader(header)
		return res
	#----------------------------------------------------------------------
	def setHeaderHidden(self,hide):
		...
		The default value is false.
		"""
		res = super(Standard_QTreeView,self).setHeaderHidden(hide)
		return res
	#----------------------------------------------------------------------
	def setIndentation(self,i):
		...
		By default, this property has a value of 20.
		"""
		res = super(Standard_QTreeView,self).setIndentation(i)
		return res
	#----------------------------------------------------------------------
	def setItemsExpandable(self,enable):
		...
		By default, this property is true.
		"""
		res = super(Standard_QTreeView,self).setItemsExpandable(enable)
		return res
	#----------------------------------------------------------------------
	def setRootIsDecorated(self,show):
		...
		By default, this property is true.
		"""
		res = super(Standard_QTreeView,self).setRootIsDecorated(show)
		return res
	#----------------------------------------------------------------------
	def setRowHidden(self,row,parent,hide):
		...
		"""
		res = super(Standard_QTreeView,self).setRowHidden(row,parent,hide)
		return res
	#----------------------------------------------------------------------
	def setSortingEnabled(self,enable):
		...
		The default value is false.
		"""
		res = super(Standard_QTreeView,self).setSortingEnabled(enable)
		return res
	#----------------------------------------------------------------------
	def setUniformRowHeights(self,uniform):
		...
		By default, this property is false.
		"""
		res = super(Standard_QTreeView,self).setUniformRowHeights(uniform)
		return res
	#----------------------------------------------------------------------
	def setWordWrap(self,on):
		...
		"""
		res = super(Standard_QTreeView,self).setWordWrap(on)
		return res
	#----------------------------------------------------------------------
	def sortByColumn(self,column,order):
		...
		"""
		res = super(Standard_QTreeView,self).sortByColumn(column,order)
		return res
	#----------------------------------------------------------------------
	def visualIndex(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).visualIndex(index)
	...
	def alternatingRowColors(self):
		...
		By default, this property is false.
		"""
		res = super(Standard_QTreeView,self).alternatingRowColors()
	...
	def autoScrollMargin(self):
		...
		"""
		res = super(Standard_QTreeView,self).autoScrollMargin()
	...
	def currentIndex(self):
		...
		"""
		res = super(Standard_QTreeView,self).currentIndex()
		isinstance(res,QT.QModelIndex)
		return res
	#----------------------------------------------------------------------
	def defaultDropAction(self):
		...
		"""
		res = super(Standard_QTreeView,self).defaultDropAction()
		isinstance(res,QT.Qt.DropAction)
		return res
	#----------------------------------------------------------------------
	def dirtyRegionOffset(self):
		...
		"""
		res = super(Standard_QTreeView,self).dirtyRegionOffset()
	...
	def doAutoScroll(self):
		...
		"""
		res = super(Standard_QTreeView,self).doAutoScroll()
		return res
	#----------------------------------------------------------------------
	def doItemsLayout(self):
		...
		"""
		res = super(Standard_QTreeView,self).doItemsLayout()
		return res
	#----------------------------------------------------------------------
	def dragDropMode(self):
		...
		"""
		res = super(Standard_QTreeView,self).dragDropMode()
	...
	def dragDropOverwriteMode(self):
		...
		"""
		res = super(Standard_QTreeView,self).dragDropOverwriteMode()
	...
	def dragEnabled(self):
		...
		"""
		res = super(Standard_QTreeView,self).dragEnabled()
	...
	def dropIndicatorPosition(self):
		...
		"""
		res = super(Standard_QTreeView,self).dropIndicatorPosition()
	...
	def editTriggers(self):
		...
		"""
		res = super(Standard_QTreeView,self).editTriggers()
	...
	def executeDelayedItemsLayout(self):
		...
		"""
		res = super(Standard_QTreeView,self).executeDelayedItemsLayout()
		return res
	#----------------------------------------------------------------------
	def hasAutoScroll(self):
		...
		"""
		res = super(Standard_QTreeView,self).hasAutoScroll()
	...
	def horizontalOffset(self):
		...
		"""
		res = super(Standard_QTreeView,self).horizontalOffset()
	...
	def horizontalScrollMode(self):
		...
		"""
		res = super(Standard_QTreeView,self).horizontalScrollMode()
	...
	def iconSize(self):
		...
		"""
		res = super(Standard_QTreeView,self).iconSize()
	...
	def itemDelegate(self):
		...
		"""
		res = super(Standard_QTreeView,self).itemDelegate()
	...
	def model(self):
		...
		"""
		res = super(Standard_QTreeView,self).model()
		isinstance(res,QT.QAbstractItemModel)
		return res
	#----------------------------------------------------------------------
	def reset(self):
		"""
		...
		"""
		res = super(Standard_QTreeView,self).reset()
		return res
	#----------------------------------------------------------------------
	def rootIndex(self):
		"""
		...
		"""
		res = super(Standard_QTreeView,self).rootIndex()
		isinstance(res,QT.QModelIndex)
		return res
	#----------------------------------------------------------------------
	def scheduleDelayedItemsLayout(self):
		...
		"""
		res = super(Standard_QTreeView,self).scheduleDelayedItemsLayout()
		return res
	#----------------------------------------------------------------------
	def selectAll(self):
		"""
		...
		"""
		res = super(Standard_QTreeView,self).selectAll()
		return res
	#----------------------------------------------------------------------
	def selectedIndexes(self):
		...
		"""
		res = super(Standard_QTreeView,self).selectedIndexes()
		return res
	#----------------------------------------------------------------------
	def selectionBehavior(self):
		...
		"""
		res = super(Standard_QTreeView,self).selectionBehavior()
	...
	def selectionMode(self):
		...
		"""
		res = super(Standard_QTreeView,self).selectionMode()
	...
	def selectionModel(self):
		...
		"""
		res = super(Standard_QTreeView,self).selectionModel()
	...
	def showDropIndicator(self):
		...
		"""
		res = super(Standard_QTreeView,self).showDropIndicator()
	...
	def startAutoScroll(self):
		...
		"""
		res = super(Standard_QTreeView,self).startAutoScroll()
		return res
	#----------------------------------------------------------------------
	def state(self):
		"""
		...
		"""
		res = super(Standard_QTreeView,self).state()
	...
	def stopAutoScroll(self):
		...
		"""
		res = super(Standard_QTreeView,self).stopAutoScroll()
		return res
	#----------------------------------------------------------------------
	def tabKeyNavigation(self):
		...
		"""
		res = super(Standard_QTreeView,self).tabKeyNavigation()
	...
	def textElideMode(self):
		...
		"""
		res = super(Standard_QTreeView,self).textElideMode()
		isinstance(res,QT.Qt.TextElideMode)
		return res
	#----------------------------------------------------------------------
	def updateEditorData(self):
		...
		"""
		res = super(Standard_QTreeView,self).updateEditorData()
		return res
	#----------------------------------------------------------------------
	def updateEditorGeometries(self):
		...
		"""
		res = super(Standard_QTreeView,self).updateEditorGeometries()
		return res
	#----------------------------------------------------------------------
	def updateGeometries(self):
		...
		"""
		res = super(Standard_QTreeView,self).updateGeometries()
		return res
	#----------------------------------------------------------------------
	def verticalOffset(self):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).verticalOffset()
	...
	def verticalScrollMode(self):
		...
		Scrolling can be done either per pixel or per item.
		"""
		res = super(Standard_QTreeView,self).verticalScrollMode()
		isinstance(res,QT.QAbstractItemView.ScrollMode)
		return res
	#----------------------------------------------------------------------
	def viewOptions(self):
		...
		"""
		res = super(Standard_QTreeView,self).viewOptions()
	...
	def viewportEntered(self):
		...
		"""
		res = super(Standard_QTreeView,self).viewportEntered()
		return res
	#----------------------------------------------------------------------
	def closeEditor(self,editor,hint):
		...
		"""
		res = super(Standard_QTreeView,self).closeEditor(editor,hint)
		return res
	#----------------------------------------------------------------------
	def closePersistentEditor(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).closePersistentEditor(index)
		return res
	#----------------------------------------------------------------------
	def commitData(self,editor):
		...
		"""
		res = super(Standard_QTreeView,self).commitData(editor)
		return res
	#----------------------------------------------------------------------
	def currentChanged(self,current,previous):
		...
		"""
		res = super(Standard_QTreeView,self).currentChanged(current,previous)
		return res
	#----------------------------------------------------------------------
	def dataChanged(self,topLeft,bottomRight):
		...
		"""
		res = super(Standard_QTreeView,self).dataChanged(topLeft,bottomRight)
		return res
	#----------------------------------------------------------------------
	def edit(self,*args,**kwargs):
		...
		"""
		res = super(Standard_QTreeView,self).edit(*args,**kwargs)
	...
	def editorDestroyed(self,editor):
		...
		"""
		res = super(Standard_QTreeView,self).editorDestroyed(editor)
		return res
	#----------------------------------------------------------------------
	def horizontalScrollbarAction(self,action):
		...
		"""
		res = super(Standard_QTreeView,self).horizontalScrollbarAction(action)
		return res
	#----------------------------------------------------------------------
	def horizontalScrollbarValueChanged(self,value):
		...
		"""
		res = super(Standard_QTreeView,self).horizontalScrollbarValueChanged(value)
		return res
	#----------------------------------------------------------------------
	def indexAt(self,point):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).indexAt(point)
		isinstance(res,QT.QModelIndex)
		return res
	#----------------------------------------------------------------------
	def indexWidget(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).indexWidget(index)
	...
	def isIndexHidden(self,index):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).isIndexHidden(index)
	...
	def itemDelegate(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).itemDelegate(index)
		isinstance(res,QT.QAbstractItemDelegate)
		return res
	#----------------------------------------------------------------------
	def itemDelegateForColumn(self,column):
		...
		"""
		res = super(Standard_QTreeView,self).itemDelegateForColumn(column)
		isinstance(res,QT.QAbstractItemDelegate)
		return res
	#----------------------------------------------------------------------
	def itemDelegateForRow(self,row):
		...
		You can call PySide.QT.QAbstractItemView.itemDelegate() to get a pointer to the current delegate for a given index.
		"""
		res = super(Standard_QTreeView,self).itemDelegateForRow(row)
		isinstance(res,QT.QAbstractItemDelegate)
		return res
	#----------------------------------------------------------------------
	def keyboardSearch(self,search):
		...
		"""
		res = super(Standard_QTreeView,self).keyboardSearch(search)
		return res
	#----------------------------------------------------------------------
	def moveCursor(self,cursorAction,modifiers):
		...
		"""
		res = super(Standard_QTreeView,self).moveCursor(cursorAction,modifiers)
		isinstance(res,QT.QModelIndex)
		return res
	#----------------------------------------------------------------------
	def openPersistentEditor(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).openPersistentEditor(index)
		return res
	#----------------------------------------------------------------------
	def rowsAboutToBeRemoved(self,parent,start,end):
		...
		"""
		res = super(Standard_QTreeView,self).rowsAboutToBeRemoved(parent,start,end)
		return res
	#----------------------------------------------------------------------
	def rowsInserted(self,parent,start,end):
		...
		"""
		res = super(Standard_QTreeView,self).rowsInserted(parent,start,end)
		return res
	#----------------------------------------------------------------------
	def scrollDirtyRegion(self,dx,dy):
		...
		"""
		res = super(Standard_QTreeView,self).scrollDirtyRegion(dx,dy)
		return res
	#----------------------------------------------------------------------
	def scrollTo(self,index,hint=None):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).scrollTo(index,hint)
		return res
	#----------------------------------------------------------------------
	def selectionChanged(self,selected,deselected):
		...
		"""
		res = super(Standard_QTreeView,self).selectionChanged(selected,deselected)
		return res
	#----------------------------------------------------------------------
	def selectionCommand(self,index,event=None):
		...
		"""
		res = super(Standard_QTreeView,self).selectionCommand(index,event)
	...
	def setAlternatingRowColors(self,enable):
		...
		By default, this property is false.
		"""
		res = super(Standard_QTreeView,self).setAlternatingRowColors(enable)
		return res
	#----------------------------------------------------------------------
	def setAutoScroll(self,enable):
		...
		Autoscroll is switched off by setting this property to false.
		"""
		res = super(Standard_QTreeView,self).setAutoScroll(enable)
		return res
	#----------------------------------------------------------------------
	def setAutoScrollMargin(self,margin):
		...
		The default value is 16 pixels.
		"""
		res = super(Standard_QTreeView,self).setAutoScrollMargin(margin)
		return res
	#----------------------------------------------------------------------
	def setDefaultDropAction(self,dropAction):
		...
		If the property is not set, the drop action is CopyAction when the supported actions support CopyAction.
		"""
		res = super(Standard_QTreeView,self).setDefaultDropAction(dropAction)
		return res
	#----------------------------------------------------------------------
	def setDirtyRegion(self,region):
		...
		"""
		res = super(Standard_QTreeView,self).setDirtyRegion(region)
		return res
	#----------------------------------------------------------------------
	def setDragDropMode(self,behavior):
		...
		This property holds the drag and drop event the view will act upon.
		"""
		res = super(Standard_QTreeView,self).setDragDropMode(behavior)
		return res
	#----------------------------------------------------------------------
	def setDragDropOverwriteMode(self,overwrite):
		...
		The models implementation of flags() should do that by not returning QT.ItemIsDropEnabled .
		"""
		res = super(Standard_QTreeView,self).setDragDropOverwriteMode(overwrite)
		return res
	#----------------------------------------------------------------------
	def setDragEnabled(self,enable):
		...
		This property holds whether the view supports dragging of its own items.
		"""
		res = super(Standard_QTreeView,self).setDragEnabled(enable)
		return res
	#----------------------------------------------------------------------
	def setDropIndicatorShown(self,enable):
		...
		This property holds whether the drop indicator is shown when dragging items and dropping..
		"""
		res = super(Standard_QTreeView,self).setDropIndicatorShown(enable)
		return res
	#----------------------------------------------------------------------
	def setEditTriggers(self,triggers):
		...
		The view will only initiate the editing of an item if the action performed is set in this property.
		"""
		res = super(Standard_QTreeView,self).setEditTriggers(triggers)
		return res
	#----------------------------------------------------------------------
	def setHorizontalScrollMode(self,mode):
		...
		Scrolling can be done either per pixel or per item.
		"""
		res = super(Standard_QTreeView,self).setHorizontalScrollMode(mode)
		return res
	#----------------------------------------------------------------------
	def setIconSize(self,size):
		...
		Setting this property when the view is visible will cause the items to be laid out again.
		"""
		res = super(Standard_QTreeView,self).setIconSize(size)
		return res
	#----------------------------------------------------------------------
	def setIndexWidget(self,index,widget):
		...
		"""
		res = super(Standard_QTreeView,self).setIndexWidget(index,widget)
		return res
	#----------------------------------------------------------------------
	def setItemDelegate(self,delegate):
		...
		"""
		res = super(Standard_QTreeView,self).setItemDelegate(delegate)
		return res
	#----------------------------------------------------------------------
	def setItemDelegateForColumn(self,column,delegate):
		...
		PySide.QT.QAbstractItemView does not take ownership of delegate .
		"""
		res = super(Standard_QTreeView,self).setItemDelegateForColumn(column,delegate)
		return res
	#----------------------------------------------------------------------
	def setItemDelegateForRow(self,row,delegate):
		...
		PySide.QT.QAbstractItemView does not take ownership of delegate .
		"""
		res = super(Standard_QTreeView,self).setItemDelegateForRow(row,delegate)
		return res
	#----------------------------------------------------------------------
	def setModel(self,model):
		...
		"""
		res = super(Standard_QTreeView,self).setModel(model)
		return res
	#----------------------------------------------------------------------
	def setRootIndex(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).setRootIndex(index)
		return res
	#----------------------------------------------------------------------
	def setSelection(self,rect,command):
		...
		"""
		res = super(Standard_QTreeView,self).setSelection(rect,command)
		return res
	#----------------------------------------------------------------------
	def setSelectionBehavior(self,behavior):
		...
		This property holds whether selections are done in terms of single items, rows or columns.
		"""
		res = super(Standard_QTreeView,self).setSelectionBehavior(behavior)
		return res
	#----------------------------------------------------------------------
	def setSelectionMode(self,mode):
		...
		This property controls whether the user can select one or many items and, in many-item selections, whether the selection must be a continuous range of items.
		"""
		res = super(Standard_QTreeView,self).setSelectionMode(mode)
		return res
	#----------------------------------------------------------------------
	def setSelectionModel(self,selectionModel):
		...
		"""
		res = super(Standard_QTreeView,self).setSelectionModel(selectionModel)
		return res
	#----------------------------------------------------------------------
	def setState(self,state):
		...
		"""
		res = super(Standard_QTreeView,self).setState(state)
		return res
	#----------------------------------------------------------------------
	def setTabKeyNavigation(self,enable):
		...
		This property holds whether item navigation with tab and backtab is enabled..
		"""
		res = super(Standard_QTreeView,self).setTabKeyNavigation(enable)
		return res
	#----------------------------------------------------------------------
	def setTextElideMode(self,mode):
		...
		The default value for all item views is QT.ElideRight .
		"""
		res = super(Standard_QTreeView,self).setTextElideMode(mode)
		return res
	#----------------------------------------------------------------------
	def setVerticalScrollMode(self,mode):
		...
		Scrolling can be done either per pixel or per item.
		"""
		res = super(Standard_QTreeView,self).setVerticalScrollMode(mode)
		return res
	#----------------------------------------------------------------------
	def sizeHintForColumn(self,column):
		...
		"""
		res = super(Standard_QTreeView,self).sizeHintForColumn(column)
	...
	def sizeHintForIndex(self,index):
		...
		"""
		res = super(Standard_QTreeView,self).sizeHintForIndex(index)
		isinstance(res,QT.QSize)
		return res
	#----------------------------------------------------------------------
	def sizeHintForRow(self,row):
		...
		"""
		res = super(Standard_QTreeView,self).sizeHintForRow(row)
	...
	def index(self, arg1, arg2=0):
		...
		This function is used in views with a vertical header to find the size hint for a header section based on the contents of the given row .
		"""
		res = super(Standard_QTreeView,self).index(arg1, arg2)
	...
	def startDrag(self,supportedActions):
		...
		"""
		res = super(Standard_QTreeView,self).startDrag(supportedActions)
		return res
	#----------------------------------------------------------------------
	def verticalScrollbarAction(self,action):
		...
		"""
		res = super(Standard_QTreeView,self).verticalScrollbarAction(action)
		return res
	#----------------------------------------------------------------------
	def verticalScrollbarValueChanged(self,value):
		...
		"""
		res = super(Standard_QTreeView,self).verticalScrollbarValueChanged(value)
		return res
	#----------------------------------------------------------------------
	def visualRect(self,index):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).visualRect(index)
	...
	def visualRegionForSelection(self,selection):
		...
		In the base class this is a pure virtual function.
		"""
		res = super(Standard_QTreeView,self).visualRegionForSelection(selection)
